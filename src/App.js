		...
		return ( <div className="App">
			...
			<AppBar position="static" color="default" title=" Bandbase">
				<Toolbar>
					...
					<SearchIcon/>
					<Input placeholder="Search..." disableUnderline="disableUnderline"/>
				</Toolbar>
			</AppBar>

			<Grid className="rowone" container="container" spacing={16}>
				<Grid item="item">
					<Paper>
						<Card className="card">
							<CardActionArea>
								...
								<CardContent>
									<Typography gutterBottom="gutterBottom" variant="headline" component="h2">
										The Bad Plus
									</Typography>
				...
				<Grid className="rowone" item="item">
					<Paper className="sidebar">
						<header className="bandHeader">The Bad Plus</header>
			...
			<grid>
				<Paper className="video">
					<iframe width="400" height="280" src="https://www.youtube.com/embed/q9hOSZGMXlI" frameborder="5" allow="autoplay; encrypted-media" allowfullscreen="allowfullscreen"></iframe>
					<iframe width="400" height="280" src="https://www.youtube.com/embed/4_6sP_dCJPY" frameborder="5" allow="autoplay; encrypted-media" allowfullscreen="allowfullscreen"></iframe>
					<iframe width="400" height="280" src="https://www.youtube.com/embed/_7xdRqAO7T4" frameborder="5" allow="autoplay; encrypted-media" allowfullscreen="allowfullscreen"></iframe>
				</Paper>
			</grid>
